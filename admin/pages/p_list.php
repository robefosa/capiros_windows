...
<section  class="row">
        ...
        <a class="link-position col-md-3" href=<?php echo '"proyect_view.php?proyect='. $pro->get_property("proyect_id") . '"';?>>Ver imagenes del proyecto</a>
        ...
        <div class="col-md-5">
          ...
          <hr>
          <a href=<?php echo '"proyect_edit.php?proyect='. $pro->get_property("proyect_id") . '"';?>>Editar este proyecto</a>
        </div>
    </section>
    <hr><hr>
